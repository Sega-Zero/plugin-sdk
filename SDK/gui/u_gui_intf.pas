...
type
  ...
  ['{11CFC811-931D-4423-9445-EABF83813B9D}']
    ...
    procedure ClearSelection; safecall;
    procedure DeleteChildren(Node: PVirtualNode; ResetHasChildren: BOOL); safecall;
    procedure DeleteNode(Node: PVirtualNode; Reindex: BOOL); safecall;
    ...
    procedure EndUpdate; safecall;
    procedure FullCollapse(Node: PVirtualNode); safecall;
    procedure FullExpand(Node: PVirtualNode); safecall;
    function GetDisplayRect(Node: PVirtualNode; Column: TColumnIndex; TextOnly: BOOL; Unclipped: BOOL): TRect; safecall;
    function GetFirst: PVirtualNode; safecall;
    function GetFirstChecked(State: TCheckState): PVirtualNode; safecall;
    ...
    function GetLast(Node: PVirtualNode): PVirtualNode; safecall;
    function GetLastChild(Node: PVirtualNode): PVirtualNode; safecall;
    function GetLastVisible(Node: PVirtualNode): PVirtualNode; safecall;
    ...
    function GetNextChecked(Node: PVirtualNode; State: TCheckState): PVirtualNode; safecall;
    ...
    function InsertNode(Node: PVirtualNode; Mode: TVTNodeAttachMode; UserData: Pointer): PVirtualNode; safecall;
    ...
    procedure Sort(Node: PVirtualNode; Column: TColumnIndex; Direction: TSortDirection; DoInit: BOOL); safecall;
    procedure SortTree(Column: TColumnIndex; Direction: TSortDirection; DoInit: BOOL); safecall;
  ...
  ['{F08FA7FC-DD51-43A7-A727-D113913F8CB7}']
    ...
    procedure Clear; safecall;
    function ColumnFromPosition(P: TPoint; Relative: BOOL): TColumnIndex; overload; safecall;
  ...
  ['{B57FA15F-CD3D-41C3-9A74-3A6BF1C8B81E}']
    ...
    procedure HideTaskbarIcon; safecall;
    function IconData: HWND; safecall;
    ...
    procedure ShowTaskbarIcon; safecall;
    function GetDesignPreview: BOOL; safecall;
    function GetEnabled: BOOL; safecall;
    function GetHandle: HWND; safecall;
    function GetHint: IString; safecall;
    ...
    function GetMinimizeToTray: BOOL; safecall;
    function GetPopupMenu: IPopupMenu; safecall;
    function GetShowHint: BOOL; safecall;
    function GetWantEnterExitEvents: BOOL; safecall;
    procedure SetDesignPreview(Value: BOOL); safecall;
    procedure SetEnabled(Value: BOOL); safecall;
    procedure SetHint(Value: IString); safecall;
    ...
    procedure SetMinimizeToTray(Value: BOOL); safecall;
    procedure SetPopupMenu(Value: IPopupMenu); safecall;
    procedure SetShowHint(Value: BOOL); safecall;
    procedure SetWantEnterExitEvents(Value: BOOL); safecall;

    property DesignPreview: BOOL read GetDesignPreview write SetDesignPreview;
    property Enabled: BOOL read GetEnabled write SetEnabled;
    property Handle: HWND read GetHandle ;
    property Hint: IString read GetHint write SetHint;
    ...
    property MinimizeToTray: BOOL read GetMinimizeToTray write SetMinimizeToTray;
    property PopupMenu: IPopupMenu read GetPopupMenu write SetPopupMenu;
    property ShowHint: BOOL read GetShowHint write SetShowHint;
